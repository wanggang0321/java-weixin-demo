package com.jfsoft.java.weixin.demo.aop;
...
/**
 * Created by JAVA on 2017/6/6.
 * @desc 初步实现一个使用Spring框架的Demo Web模块
 */
@Aspect
@Component
public class ControllerLogAspect {
    ...
    @Pointcut("within(com.jfsoft.java.weixin.demo..*.controller..*)")
